...
<title>Insert title here</title>
	...
	$(function (){
		var url = "http://localhost:8989/web06/LinkageServlet?state=init";
	...
	$(function (){
		$("#province").change(function (){
			//alert(this.value);
			var url2 = "http://localhost:8989/web06/LinkageServlet?state=city&pid="+this.value;
	...
	$(function (){
		$("#city").change(function (){
			//alert(this.value);
			var url3 = "http://localhost:8989/web06/LinkageServlet?state=area&cid="+this.value;
